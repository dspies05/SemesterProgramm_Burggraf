...
\newlength{\frontpanelmargintop}
\newlength{\panelmarginbottom}
\newlength{\panelmarginx}
\newlength{\panelintershift}
\newlength{\panelheight}
\setlength{\panelmargintop}{4mm}
\setlength{\frontpanelmargintop}{6mm}
\setlength{\panelmarginbottom}{6mm}
\setlength{\panelmarginx}{6mm}
\setlength{\panelintershift}{1mm}
...
\vspace*{\frontpanelmargintop}%
\hspace*{\panelmarginx}%
\begin{minipage}[t][\dimexpr\panelheight-\frontpanelmargintop-\panelmarginbottom\relax][t]{\dimexpr\panelwidth-2\panelmarginx\relax}%
}{%
\end{minipage}%
\end{minipage}%
}
...
% Put full-page PDF art in the background without changing text flow.
\AddToShipoutPictureBG*{%
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight,page=1]{pdfs/overlay_band.pdf}}%
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight,page=1]{pdfs/Rahmen.pdf}}%
}
...
\AddToShipoutPictureBG*{%
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight,page=2]{pdfs/Rahmen.pdf}}%
}

\hspace*{1.5mm}
\makebox[\paperwidth][l]{%
\begin{panelgroup}{4}{
% Match page 1 panel spacing.
\setlength{\columnsep}{\dimexpr1.5\panelmarginx\relax}
\setlength{\multicolsep}{0pt}
% Apply the intershift only to the last column on page 2.
...
\eventitem{Fr 08.05.}{Begrüßungsabend Stiftungsfest \eventmeta{18\,h ct / ho} adH}
\eventitem{Sa 09.05.}{
    \eventpoints{%
    \eventpoint{CC und AHC \eventmeta{13\,h ct / ho} adH}\\
    \eventpoint{Stiftungsfestkommers \eventmeta{19\,h ct / ho} \\ Pfründnerstraße 20, Nürnberg}\\
    }}
